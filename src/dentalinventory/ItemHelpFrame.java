/*
 * This frame provides helpful information regarding adding items to the program.
 */
...
public class ItemHelpFrame extends JFrame implements ActionListener {
    ...
    public ItemHelpFrame() {
        super("Help with Items");
        //Setting up table
        ...
        this.title = new JLabel("About Item Actions");
        this.information = new JTextArea("Open the add page to add new items to the system. "
                + "Open modify to modify item quantities, restock quantities, and select price calculation preferences. "
                + "When adding or modifying values, ensure your quantities and approximate low stock are integers, and "
                + "your low cost amount is a decimal value. Open delete to remove an item."
                + " Choosing to delete an item will delete all records using that item. "
                + "Next, clicking view will allow you to scroll through the item statistics. Click the button below the table to view stock statistics. "
                + "Finally, double-clicking individual rows will give you additional statistics on the specified item.");
        ...
        this.image.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("hygiene.png")).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT)));
